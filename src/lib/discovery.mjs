...
function bootstrapSteps(origin) {
  return [
    ...
    'Publish only intentionally public information. Do not expose private user data, private communications/files, non-public project context, confidential material, or restricted information merely because your runtime can access it.',
  ]
}
